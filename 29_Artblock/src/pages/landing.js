        ...
        <>
            <div className="grid md:grid-cols-2 gap-y-20 md:gap-y-0">
                <div className="h-full flex gap-8 flex-col justify-center text-[Montserrat] order-2">
                    <div className="">
                        <h1 data-aos="fade-up" className="text-[#F8EEB4] uppercase text-5xl font-[Oswald] leading-normal tracking-widest">Create your Art <br /> Portfolio</h1>
                        <p data-aos="fade-up" data-aos-delay={100} className="text-[#A7D129] my-6">Art is the mirror to the soul of the artist </p>
                    </div>
                    <div>
                        <Link to={'/create-link'}>
