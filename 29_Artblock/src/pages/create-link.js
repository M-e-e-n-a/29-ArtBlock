            ...
            <div className="font-[Montserrat] mx-6">
                <form className="flex gap-8 flex-col" onSubmit={handleFormSubmit}>
                    <div data-aos-delay={100} data-aos="fade-up" className="flex flex-col gap-2">
                        <label className="text-[#C9FF28] font-semibold text-sm uppercase">Enter Total shares *</label>
                    ...
                    >
                        <div data-aos-delay={200} data-aos="fade-up" className="flex flex-col gap-2">
                            <label className="text-[#C9FF28] font-semibold text-sm uppercase">Date of issue</label>
                    ...
                    <div data-aos-delay={300} data-aos="fade-up" className="flex flex-col gap-2">
                        <label className="text-[#C9FF28] font-semibold text-sm w-full flex justify-between items-center">
                            ...
                            <div onClick={handleGetNFTAddress} className="text-sm cursor-pointer hover:underline underline-offset-4"> your NFT IPFSAddress</div>
                        </label>
                ...
                <div className="my-4">
                    <h1 data-aos-delay={500} data-aos="fade-up" className="text-white font-semibold flex items-center text-xl gap-1 uppercase"><AiOutlineFieldTime className="text-2xl" /> My History</h1>
