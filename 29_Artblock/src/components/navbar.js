        ...
        <div className="border-b-[#2d2c2c] border-b-[2px]">
            <div className="grid grid-cols-12 my-10 md:mx-16 mx-8 font-[Montserrat]">
                <div className="col-span-4 flex gap-12 items-center justify-between">
                    ...
                    <Link to={'/redeem'}><span className="text-[#C9FF28] hidden md:block font-semibold uppercase">Buy</span></Link>
                    <Link to={'/create-link'}><span className="text-[#C9FF28] hidden md:block font-semibold uppercase">Upload</span></Link>
